...
assetForm.submit(function (e) {
    ...
    if (tokenName === '') {
        ...
        standardtokenContract.deploy({
            ...
            if (isMainNetwork) {
                statusText.innerHTML = '<p align="center">Contract deployment is in progress.<br> <strong>Transaction hash: </strong><br> <a href="https://etherscan.io/tx/' + transactionHash + '" target="_blank">' + transactionHash + '</a></p>'
            } else if (isRopsten) {
                ...
                statusText.innerHTML = 'Contract deployment is in progress. Transaction hash: ' + transactionHash +'<br><small>Please wait for confirmation..</small>'
